...
public class DroneData extends RobotData {
	...
	public void calculateSearchDestinations(RobotController rc) {
		...
		searchDestinations = new MapLocation[] {horizontalSymmetryLocation, verticalSymmetryLocation, rotational90SymmetryLocation, rotational180SymmetryLocation, rotational270SymmetryLocation};
